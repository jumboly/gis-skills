...
```bash
python3 scripts/detect_format.py --input data.shp
```
...
```bash
python3 scripts/convert_format.py --input data.shp --output data.geojson
```
...
- `references/format-specs.md` — 各フォーマットの仕様、制限事項、エンコーディング
